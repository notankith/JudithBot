...
○ 𝖲𝗎𝗉𝗉𝗈𝗋𝗍 𝖦𝗋𝗈𝗎𝗉 : <a href='https://t.me/LucaMovies'>𝖳𝖺𝗉 𝖧𝖾𝗋𝖾</a>"""
    ...
    SOURCE_TXT = """<b>NOTE:</b>
Have A Lovely Day Y'all! 🧁 -SN
<b>DEV:</b>

- <a href=https://t.me/ExaBots>S N</a>

- Source Code Is Confidential Contact @CristinaRodloBot """ #please don't change repo link give credit :)
...
Message <b>: {}</b>"""
    ...
    CAPTION = """
📂 <em>File Name</em>: <code>Liana|{file_name}</code> 

🖇 <em>File Size</em>: <code>{file_size}</code> 

❤️‍🔥 </i>Movie Bot</i> [Liana Bot](https://t.me/elianamoviebot)  
